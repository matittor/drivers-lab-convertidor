...
Key points:
- HMP4040 does NOT support POWER readback via SCPI (SYST:ERR -100).
...
- After every snapshot (manual/auto), writes latest_psu.json for downstream tools (GL automation).
...
class RampGUI(tk.Tk):
    ...
    def _write_latest_json(self, v_total, i_total, p_total):
        ...
        try:
            ...
            # No hacemos crash por esto; solo es un output auxiliar
            pass
    ...
    def _read_snapshot(self):
        ...
        # Write latest JSON for downstream automation (GL tool)
